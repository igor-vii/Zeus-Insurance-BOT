...
- [ ] How It Works — добавить соединительные линии/стрелки между шагами, анимацию по очереди
- [ ] Services cards — glassmorphism эффект, иконки крупнее, hover = reveal дополнительного контента
- [ ] Код-пример (SDK секция) — добавить подсветку синтаксиса, анимацию набора текста (typewriter)
...
- [ ] Micro-interactions — stagger reveal карточек, parallax у Hero
- [ ] Типографика — hero текст можно сделать с gradient или outlined эффектом
- [ ] Navbar — добавить прогресс-бар скролла или blur-интенсивность при скролле
